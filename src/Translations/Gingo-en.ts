const PROJECT_DESC = `Gingo is a real-time delivery and chat application, where users can chat at any time with establishments or with each other.
...
const CHALLENGE = `My biggest challenge was with the construction of the chat, both in the back and in the frontend, due to its offline first construction in the frontend and its system of ensuring that no messages are lost due to internet oscillation.
...
const LEARNING = `With this project I learned to use express and socket on the backend with Node.
...
const TRANSLATION = {
    "prj1.description": PROJECT_DESC,
    "prj1.challenge": CHALLENGE,
    "prj1.learned": LEARNING,
