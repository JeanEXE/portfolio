    ...
    const renderMobile = () => (
        <div className='py-14 px-5 grid grid-row-2 gap-16 justify-center'>
            <div className='flex-col justify-center items-center'>
                <p className='flex justify-center'>Coded by me, made by <img src={heart} className='w-4' />.</p>
            ...
            <div className='text-center'>
                ...
                <p className='flex  justify-center'>proatividade e <img src={coffe} className='w-5 h-5' /></p>
            </div>
        </div>
    )

    const renderWeb = () => (
        <div className='py-20 grid grid-col-2 grid-flow-col  gap-36  lg:gap-80 justify-center items-center'>
            <div>
                <p className='flex'>Coded by me, made by  <img src={heart} className='h-5' />.  Especially</p>
            ...
            <div className='text-center'>
                Todo trabalho que faço sempre terá muito<p className='flex justify-center'>esforço dedicação, proatividade e <img src={coffe} className='w-5 h-5' /></p>
            </div>
        </div>
    )
    ...
    return (
        <div className='pb-5'>
            ...
            <div
                ...
                className='mt-6 mb-5 flex align-center justify-center md:justify-start md:ml-16 animate-bounce'
            >
