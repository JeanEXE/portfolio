    ...
    const renderMobile = () => (
        <div className='flex flex-col  items-center'>
            ...
            <div className='flex flex-col items-center mt-3 font-semibold'>
                <p className='text-[16px] sm:text-[22px] mb-3'>Jean Reis <span className='text-[13px] sm:text-[18px]'>- {t('cidade')}</span></p>
    ...
    const renderWeb = () => (
        <div className='flex'>
            ...
            <div className='font-semibold'>
                <p className='text-[24px] 2xl:text-[26px]'>Jean Reis <span className='text-[20px] 2xl:text-[22px]'>- {t('cidade')}</span></p>
