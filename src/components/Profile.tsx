    ...
    const renderMobile = () => (
        <div className='flex flex-col  items-center'>
            ...
            <div className='flex flex-col items-center mt-3 font-semibold'>
                ...
                <p className='text-[35px] sm:text-[55px] tracking-[5px] hero glitch layers leading-none' data-text="Fullstack"><span>Fullstack</span></p>
                <p className='text-[35px] sm:text-[55px] tracking-[5px] hero glitch layers' data-text="Developer"><span>Developer</span></p>
